...
/// <summary>
/// Frontier persistence (session-save): loads a grid file onto a map at an optional offset/rotation.
/// </summary>
...
public sealed class PersistenceLoadGridCommand : LocalizedEntityCommands
{
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        if (!sys.MapExists(mapId))
        {
            ...
            sys.CreateMap(mapId, false); // doesn't runmapinit to be conservative.
        }
        ...
        {
            shell.WriteLine($"Grid successfully loaded with id '{grid}' on Map {mapId} {offset} ({rot.Degrees}º).");
        }
    }
}
